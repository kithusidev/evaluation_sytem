            ...
            <ul class="nav navbar-top-links navbar-right">
                ...
                <!-- <li class="dropdown"> -->
                    ...
                    <!-- <ul class="dropdown-menu dropdown-user"> -->
                        ...
                        <!-- </li> -->
                        <li class="divider"></li>
                        <li style="color:#ffffff"><a href="logoutadmin" style="color:#ffffff"><i class="fa fa-sign-out fa-fw"></i> Logout</a>
                        </li>
                    <!-- </ul> -->
                    <!-- /.dropdown-user -->
                <!-- </li> -->
...
<li><a href="dashboard.php?info=dep"><i class="fa fa-book fa-fw"></i> Departmental Results</a></li>
    ...
    <script src="{{url('css/metisMenu.min.js')}}"></script>

  
    <!-- Custom Theme JavaScript -->
    <script src="{{url('css/sb-admin-2.js')}}"></script>
